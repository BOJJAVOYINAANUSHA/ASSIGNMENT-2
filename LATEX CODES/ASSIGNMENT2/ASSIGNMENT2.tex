...
\begin{lemma}
\label{lemma}
The coordinates of \textbf{A} and \textbf{D} can be written as follows:
\begin{align}
  & \vec{A} = p \mathbf{b}  \quad \brak{\because \vec{B}=\myvec{0\\0}} \label{eq a}
\\
  & \vec{D} =\vec{C} + r \mathbf{c} \label{eq b}
\end{align}
 \item Let us define b,c as:
\begin{align}
 \mathbf{b} = \myvec{\cos B \\\sin B } ,\mathbf{c} = \myvec{\cos C\\\sin C }
\end{align}
\end{lemma}
\begin{itemize}
...
\begin{figure}[!ht]
\centering
\includegraphics[ width=\columnwidth ,height= 12cm]{FIGURE.png}
